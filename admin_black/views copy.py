...
def dashboard(request):
    ...
    "to_draw" : [
    #{"data" : CAPMOIS.tolist() , "labels" : CAPMOIS.index.tolist(), "id" : "clientNber" , "type" : "pie" },
    {"data" : employee_sales.total_revenue.tolist() , "labels" : employee_sales.index.to_list(), "id" : "employee_sales" , "type" : "bar" },
    {"data" : CA_par_produit.total_quantity.to_list() ,"labels" :  CA_par_produit.index.to_list(),  "id" : "CA_par_produit" , "type" : "bar" }, 
    {"data" : revenu_produit.total_revenue.tolist() , "labels" : revenu_produit.product_name.to_list(), "id" : "revenu_produit" , "type" : "pie" },
    {"data" : CRM_statut.values.tolist() , "labels" : CRM_statut.index.tolist(), "id" : "crm_statut" , "type" : "pie"},
    {"data" :CA_par_employee.total_sales.tolist()  , "labels" : CA_par_employee.employee_name.tolist(), "id" : "ca_par_employee" , "type" : "bar"},
    ]
  }
